...
real_name_server = '216.239.34.10' # Research public DNS servers to find a valid DNS server IP address to use
...
if __name__ == '__main__':
    ...
    print(result2)
    result3 = query_local_dns_server(domainList[0],question_type)
    print(result3)
